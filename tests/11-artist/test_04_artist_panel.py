...
def test_artist_svg_load():
    ...
    pablo.drawShape( shape, 0, -2.2, 2.2 )
    pablo.drawShape( shape, 1, -1.1, 2.2 )
    pablo.drawShape( shape, 2,   0, 2.2 )
    pablo.drawShape( shape, 3, 1.1, 2.2 )
    pablo.drawShape( shape, 4, 2.2, 2.2 )
    ...
    pablo.drawShape( shape, 5, -2.2, 0 )
    pablo.drawShape( shape, 6, -1.1, 0 )
    pablo.drawShape( shape, 7,   0, 0 )
    pablo.drawShape( shape, 8, 1.1, 0 )
    pablo.drawShape( shape, 9, 2.2, 0 )
    
    pablo.drawShape( shape, 15, -2.2, -1.1 )
    pablo.drawShape( shape, 16, -1.1, -1.1 )
    pablo.drawShape( shape, 17,   0, -1.1 )
    pablo.drawShape( shape, 18, 1.1, -1.1 )
    pablo.drawShape( shape, 19, 2.2, -1.1 )

    pablo.drawShape( shape, 20, -2.2, -2.2 )
    pablo.drawShape( shape, 21, -1.1, -2.2 )
    pablo.drawShape( shape, 74,   0, -2.2 )
    pablo.drawShape( shape, 33, 1.1, -2.2 )
    pablo.drawShape( shape, 42, 2.2, -2.2 )
